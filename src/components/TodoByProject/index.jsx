                ...
                <div style={{ display: this.state.showTodoDisplay }}>
                    <div className="row">
                        <div className="col-xs-3 col-md-2 check">
                            ...
                            <div><button className="delete-link" onClick={() => {this.deleteTodo(this.props.todo._id)}}><i className="fa fa-trash-o" aria-hidden="true" title="Delete Todo"></i></button></div>
                        </div>
